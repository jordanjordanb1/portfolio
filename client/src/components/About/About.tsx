                        ...
                        <Row>
                            <Col xs="12">
                                <p className="about-paragraph">
                                    My name is Jordan Barbosa, and I have been
                                    programming since I was about 14 years old.
                                    I started off learning HTML and PHP (strange
                                    right?!), but soon after started to learn
                                    JavaScript. I hated JavaScript, then I
                                    quickly learned jQuery, and that made
                                    JavaScript a little better.
                                </p>

                                <p className="about-paragraph">
                                    Now with the rise of other more advanced
